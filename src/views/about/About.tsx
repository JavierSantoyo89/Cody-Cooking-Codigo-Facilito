    ...
    <MainWrapper>
      ...
      <CustomGrid>
        ...
        <div>
          ...
          <PeopleDescription>
            Soy un desarrolador que le interesa mucho el área del Frontend,
            tengo conocimientos bastante amplios en tecnologías como HTML, CSS,
            y Javascript. Actualmente me sigo formando como Frontend Developer
            para poder ejercer funciones de dicho stack y sacar proyectos
            adelante de la mano de personas con otros perfiles, tambien tengo
            mucha curiosidad por el lado del Diseño UX/UI para crear interfaces
      ...
      <CustomGrid>
        ...
        <div>
          ...
          <PeopleDescription>
            ...
            y testing, titulado en LTI. A pesar de tener una discapacidad
            motriz, busco oportunidades de desarrollo remoto. Tengo experiencia
            en proyectos remotos, trabajando con responsabilidad, en equipo y
            siguiendo las políticas de privacidad del cliente/empresa. Estoy
            comprometido con ofrecer soluciones de calidad en el desarrollo web.
          </PeopleDescription>
        </div>
        <SocialContainer>
          <Link
          ...
          <Link to="https://twitter.com/FcoSantoyoRios" target="_blank">
            <TwitterLogo />
          </Link>
      ...
      <CustomGrid>
        ...
        <div>
          ...
          <PeopleDescription>
            ...
            mejorar mis habilidades y contribuir al desarrollo de soluciones web
            innovadoras 🙌 ✨.
          </PeopleDescription>
        </div>
        <SocialContainer>
      ...
      <CustomGrid>
        ...
        <div>
          ...
          <PeopleDescription>
            Soy publicista y diseñador gráfico de profesión, pero frontend de
            corazón. Cuento con varios años de experiencia en el desarrollo de
            aplicaciones crossbrowsing, principalmente con React. Me apasiona
            mantenerme actualizado y siempre estoy dispuesto a ayudar y enseñar
