...
<Link to="https://www.themealdb.com/api/json/v1/1/search.php?s=[strMeal]">https://www.themealdb.com/api/json/v1/1/search.php?s=[strMeal]</Link>
...
<Link to="https://www.themealdb.com/api/json/v1/1/lookup.php?i=[idMeal]">https://www.themealdb.com/api/json/v1/1/lookup.php?i=[idMeal]</Link>
...
<Link to="https://www.themealdb.com/api/json/v1/1/categories.php">https://www.themealdb.com/api/json/v1/1/categories.php</Link>
...
<Link to ="https://www.themealdb.com/api/json/v1/1/list.php?c=list">https://www.themealdb.com/api/json/v1/1/list.php?c=list</Link>
